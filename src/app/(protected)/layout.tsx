...
import {
  Briefcase, Calculator, LayoutDashboard, Package, PanelLeft, Settings,
  ShoppingCart, Users, Wrench, Warehouse, Truck, FileText, LineChart, UsersRound,
  Megaphone, User, Shield, Book, Contact, Building, FileCog, Landmark, Home,
  HeartHandshake, ArrowRightLeft, FileArchive, BookUser, BadgePercent, MessageSquare,
  ClipboardList, Fingerprint, Palette, Building2, BookLock, BookText, Gavel,
  Clipboard, BookHeadphones, MessagesSquare, Database,
} from "lucide-react";
...
export default function ProtectedLayout({
  ...
  React.useEffect(() => {
    // Si la sesión ha terminado de cargar y no hay usuario, redirige al login.
    if (!isLoading && !user) {
  ...
  // Una vez autenticado, muestra el layout completo.
  return (
